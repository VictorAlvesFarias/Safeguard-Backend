...
namespace Test.IntegrationTests
{
    public class AppFileTests : IClassFixture<BasicTests>
    {
        ...
        [Fact]
        public async Task<BaseResponse<Provider>> Post_AppFIle()
        {
        ...
        [Fact]
        public async Task Delete_AppFile()
        {
            var provider = Post_AppFIle().Result.Data;
        ...
        [Fact]
        public async Task Update_AppFile()
        {
            var provider = Post_AppFIle().Result.Data;
